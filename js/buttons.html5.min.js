...
(g=e.messageTop+f+f+g);e.messageBottom&&(g=g+f+f+e.messageBottom);b.customize&&(g=b.customize(g,b,c));b=n("<textarea readonly/>").val(g).appendTo(d);if(x.queryCommandSupported("copy")){d.appendTo(c.table().container());b[0].focus();b[0].select();try{var p=x.execCommand("copy");d.remove();if(p){c.buttons.info(c.i18n("buttons.copyTitle","Copiar para área de transferência"),c.i18n("buttons.copySuccess",{1:"Copied one row to clipboard",_:"Copiado %d linhas para a área de transferência"},a.rows),2E3);this.processing(!1);return}}catch(q){}}p=
